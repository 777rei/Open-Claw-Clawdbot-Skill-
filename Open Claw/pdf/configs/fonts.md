...
# macOS: ~/.openclaw/workspace/fonts/truetype/chinese/NotoSerifSC-*.ttf
# Linux: /usr/share/fonts/Noto_Serif_SC/NotoSerifSC-*.ttf
...
# Fallback / legacy Chinese fonts
pdfmetrics.registerFont(TTFont('Noto Sans SC', f'{FONT_DIR}/chinese/NotoSansSC[wght].ttf'))  # sans-serif fallback
