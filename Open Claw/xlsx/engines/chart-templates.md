...
_font_path = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'fonts', 'truetype', 'chinese', 'NotoSansSC[wght].ttf')
if not os.path.exists(_font_path):
    # Fallback: try workspace fonts
    _font_path = os.path.expanduser('/usr/share/fonts/truetype/chinese/NotoSansSC[wght].ttf')
